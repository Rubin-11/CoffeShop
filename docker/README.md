...
-------|--------------------------
Webserver|[localhost:1988](http://localhost:1988)
Mailhog web interface|[localhost:1989](http://localhost:1989)
PostgreSQL|**host:** `localhost`; **port:** `1992`
...
`docker-compose exec php-fpm chown -R www-data:www-data /CoffeeShop/public`
